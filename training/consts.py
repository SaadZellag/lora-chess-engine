...
_FEATURE_TYPES = {
    ...
    'HALF_KP_VIRT': ['HalfKP_Virt', 42240],
}
...
CRELU_ACTIVATION_MAX = 128

FEATURE_SCALE = 256
FEATURE_BIAS_SCALE = 256
FEATURE_CRELU_DOWNSCALE = FEATURE_BIAS_SCALE // CRELU_ACTIVATION_MAX

WEIGHT_SCALE = 64
BIAS_SCALE = CRELU_ACTIVATION_MAX * 64 # input comes from a crelu activation
REGULAR_CRELU_DOWNSCALE = BIAS_SCALE // CRELU_ACTIVATION_MAX


MIN_WEIGHT = -128 / WEIGHT_SCALE
MAX_WEIGHT = 127 / WEIGHT_SCALE
